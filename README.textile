...
To add form-based authentication to your application, implement the <code>FormAuthAdapter</code>.
...
(defrecord DemoAdapter []
  ...
  (validate-password [this]
    (fn [m] (... your implementation here...))))
</code>
</pre>

Create form authentication routes

<pre>
<code>
(defroutes routes
  (form-authentication-routes (fn [request content] (layout c))
                              (DemoAdapter.))
...
Apply this policy to your project
