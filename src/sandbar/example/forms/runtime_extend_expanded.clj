(ns sandbar.example.forms.runtime-extend-expanded
  "The same exact functionality as runtime-extend but instead of using
   the defform and extend-form macros, the code that the macros generate is
   used."
